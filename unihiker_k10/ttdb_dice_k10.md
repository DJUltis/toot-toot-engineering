# Dice TTDB (K10)
Compact Dice TTDB sample sized for on-device navigation.

```mmpdb
db_id: mmpdb:sample:dice:k10
db_name: "Dice (K10)"
coord_increment:
  lat: 1
  lon: 1
...
umwelt:
  ...
  scope: "A compact dice TTDB for K10 navigation."
cursor_policy:
...
agent_note: "Dice TTDB compact set for K10."
```
